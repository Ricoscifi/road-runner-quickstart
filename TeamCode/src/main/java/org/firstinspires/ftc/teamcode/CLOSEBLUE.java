...
public class CLOSEBLUE extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder preload = drive.actionBuilder(beginPose)
                ...
                .strafeTo(new Vector2d(-3, -67), new TranslationalVelConstraint(80), new ProfileAccelConstraint(-55, 90))
                .waitSeconds(0.65)
                .setTangent(90)
                ...
                .splineTo(new Vector2d(11, -65), Math.toRadians(-90))
                .waitSeconds(0.1)
                ...
                .splineTo(new Vector2d(33.5, -65), Math.toRadians(-90), new TranslationalVelConstraint(55), new ProfileAccelConstraint(-25,55))
                .waitSeconds(0.1)
                .setTangent(Math.toRadians(90))
                .strafeToLinearHeading(new Vector2d(-16, -24), Math.toRadians(45), new TranslationalVelConstraint(90), new ProfileAccelConstraint(-45, 90));
